...
Структура сценария: Сравнение различных стратегий обхода объектного графа.
	...
	И количеством элементов в графе 500.

	Если выбрана эталонная стратегия обхода графа "DepthFirstSingleThreadStrategy" (однопоточный алгоритм обхода вглубь)
	И выбрана другая <Стратегия> обхода графа,
	То должен быть <прирост скорости> обхода относительно эталонного алгоритма.
	
	Примеры: 
	| Стратегия                        | прирост скорости |
	| BreadthFirstSingleThreadStrategy | 10               |
